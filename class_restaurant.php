...
class menuDuJour {
    ...
    private function getDayOfTheWeek($dw){
    ...
    public function marcheBiot(){
        ...
        switch ($dw){
            case "Lundi":
                preg_match_all("/(?<=<div><p class='item-text'>)(.*)(<\/p>)/", $curlResult, $menu);
                return($menu[1][0]);
                break;
            case "Mardi":
                ...
                break;
            case "Mercredi":
                preg_match_all("/(?<=Mardi<\/div><\/div><\/li><li class='even'><div><p class='item-text'>)(.*?)(<\/p>)/", $curlResult, $menu);
                return($menu[1][0]);
                break;
            case "Jeudi":
